...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.43.222/demoandroid/retrieve.php";
    Employee employee;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.222/demoandroid//delete.php",
